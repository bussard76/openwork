  ...
  return (
    <>
      ...
      <Show when={layout.fileTree.opened()}>
        <Portal mount={document.getElementById("sidebar-file-tree-slot")!}>
          <div class="absolute inset-0 flex flex-col overflow-hidden border-t border-border-weak-base group/filetree">
            <Tabs
              variant="pill"
              value={fileTreeTab()}
